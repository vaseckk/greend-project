              ...
              <section className="task-section">
                <section className="task-basic">
                  <article className="task-basic_title" ref={dropdownNewTask.dropdownRef}>
                    <div className="task-basic_title_container">
                      ...
                      <div className="task-basic_project-choose_container">
                        <button className="task-basic_project-choose" onClick={dropdownNewTask.toggleDropdown}>
                          <input
                            name="text"
                            id=""
                            placeholder='выбрать родительский компонент...'
                            value={dropdownNewTask.inputValue}
                            onChange={dropdownNewTask.handleInputChange}
                          >
                          </input>
                          <img src="../img/chevron.png" alt=""/>
                        </button>

                        {dropdownNewTask.isOpen && (
                          <div className='choose-project'>
                            <ul>
                              {dropdownNewTask.items.map((item) => (
                                <li key={item} onClick={() => dropdownNewTask.handleItemSelect(item)}>
                                  {item}
                                </li>
                              ))}
                            </ul>
                  ...
                  <article className="task-basic_time-controller">
                    <div className="task-basic_time-start_container">
                      <p>Дата начала проекта</p>
                      <div className="task-basic_time-start">
                        <input
                          type="date"
                        />
                      </div>
